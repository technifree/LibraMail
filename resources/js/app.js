...
// LibraMail 0.4.5 — démarrage Windows robuste
  ...
  function applyAppVersion() {
    const rawVersion = String(window.NL_APPVERSION || '0.4.4').replace(/^v/i, '');
  ...
  async function exportStatisticsCsv() {
    ...
    try {
      ...
      console.error('[LibraMail] Export CSV statistiques :', error);
  ...
  function appVersion() {
    return String(window.NL_APPVERSION || '0.4.4').replace(/^v/i, '');
  }
